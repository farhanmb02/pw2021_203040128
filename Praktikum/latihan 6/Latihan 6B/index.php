                ...
                <form action="" method="post">
                    ...
                    <?php foreach($mahasiswa as $mhs):?>
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["jurusan"]; ?></td>
                            <td>
                                <a href="ubah.php?id=<?= $mhs["id"]; ?>" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="hapusdata.php?id=<?= $mhs["id"]; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </td>
