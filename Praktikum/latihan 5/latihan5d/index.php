                        ...
                        <tbody>
                            ...
                            <?php foreach ($karyawan as $data)  :?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="link  " href="ubah.php?no_pegawai=<?= $data["no_pegawai"]; ?>""><button type="button" class="btn btn-primary  badge badge-pill tombol ">Ubah</button></a>
                                        <a class="link  " href="hapus.php?no_pegawai=<?= $data["no_pegawai"]; ?>" onclick=
                "return confirm('Apakah anda yakin akan menghapus data ini?')"><button type="button" class="btn btn-danger  badge badge-pill tombol ">hapus</button></a>
                                    </td>
                                </tr>
                                <?php $i++;
                            endforeach;?>
                    ...
                    <a href="tambah.php"><button type="button" class="btn btn-success  badge badge-pill tombol ">Tambah Data</button></a>
                    </div>
